...
def active_items(item, list_of_item):
    for nested_item in list_of_item:
        if nested_item['parent'] and nested_item['parent'].id == item['id']:
